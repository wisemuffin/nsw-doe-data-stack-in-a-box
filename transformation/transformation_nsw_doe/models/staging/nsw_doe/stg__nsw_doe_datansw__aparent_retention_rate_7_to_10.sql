with source as (
    select *, from {{ source('raw', 'raw_nsw_doe_datansw_aparent_retention_rate_7_to_10') }}
),
...
final as (
    select
        ...
        cast(aparent_retention_rate_7_to_10 as DECIMAL) as aparent_retention_rate_7_to_10,
    from unpivoted
)
