...
from dagster import AssetsDefinition, SourceAsset, materialize, DailyPartitionsDefinition

pprint(sys.path)

from demo_pipeline_jaffle_shop import resources_by_env
from demo_pipeline_jaffle_shop.assets.raw import raw_orders_py, raw_customers_py
from demo_pipeline_jaffle_shop.assets.transformation import jaffle_shop_dbt_assets
from demo_pipeline_jaffle_shop.assets.machine_learning import prophet_forecast, simple_forecast

from demo_pipeline_jaffle_shop import all_assets
...
if __name__ == "__main__":
    ...
    materialize(
        assets=list_to_typed_list( all_assets), # have to pass in all assets so it know the dependancices
